...
/*
 * NSVersionOfRunTimeLibrary() returns the current_version number that the main
...
NSCreateObjectFileImageFromFile(const char *pathName,
    ...
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_1, __MAC_10_5, __IPHONE_NA,
                                   __IPHONE_NA);
extern NSObjectFileImageReturnCode
...
NSIsSymbolDefinedInObjectFileImage(NSObjectFileImage objectFileImage,
    ...
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_1, __MAC_10_4, __IPHONE_NA,
                                   __IPHONE_NA);
extern void *
...
extern bool NSHasModInitObjectFileImage(NSObjectFileImage objectFileImage)
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_3, __MAC_10_5, __IPHONE_NA,
                                   __IPHONE_NA);
